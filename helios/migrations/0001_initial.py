    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('datatype', models.CharField(default=b'phoebus/Election', max_length=250)),
                ...
                ('workflow_type', models.CharField(default=b'homomorphic', max_length=250, choices=[(b'homomorphic', b'Homomorphic'), (b'mixnet', b'Mixnet')])),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('status', models.CharField(default=b'pending', max_length=255, choices=[(b'pending', b'Pending'), (b'mixing', b'Mixing'), (b'error', b'Error'), (b'finished', b'Finished')])),
                ('mix_error', models.TextField(null=True, blank=True)),
                ('election', models.ForeignKey(related_name='mixnets', to='helios.Election')),
            ],
            options={
                'ordering': ['-mix_order'],
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('mixnet', models.ForeignKey(related_name='mixed_answers', to='helios.ElectionMixnet')),
            ],
            options={
            },
            bases=(models.Model, helios.datatypes.LDObjectContainer),
        ...
        migrations.AlterUniqueTogether(
            name='mixedanswers',
            unique_together=set([('mixnet', 'question')]),
        ),
        migrations.AlterUniqueTogether(
            name='electionmixnet',
            unique_together=set([('election', 'mix_order'), ('election', 'name')]),
        ),
        migrations.AddField(
            model_name='castvote',
            name='voter',
